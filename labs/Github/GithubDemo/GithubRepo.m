...
static NSString * const kClientId = @"2f293c0095b05d866d91";
static NSString * const kClientSecret = @"99896121e4bdd09b848d53d63a8b159b0533fa20";
...
- (void)initializeWithDictionary:(NSDictionary *)jsonResult {
    ...
    self.desc = jsonResult[@"description"];
}
